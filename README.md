...
## Note on current development and `acados`
ACADO Toolkit is **not** actively developed since 2018.
The group around Prof. Moritz Diehl focused their work on developing the `acados` software package instead, which implements similar algorithms and is actively maintained, see
